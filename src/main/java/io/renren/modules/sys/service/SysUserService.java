...
public interface SysUserService extends IService<SysUserEntity> {
	...
	PageUtils queryPageGroup(Map<String, Object> params);
	//PageUtils queryPageGroup(Map<String, Object> params, @Param(Constants.WRAPPER) Wrapper<SysUserEntity> queryWrapper,Long deptId, String dingName);

	PageUtils queryPageRole(Map<String, Object> params);
	...
	void saveDingUser(SysUserEntity user);
